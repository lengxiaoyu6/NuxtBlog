                ...
                <div class="lg:col-span-8 space-y-12">
                    <header class="mb-16">
                        <div class="relative inline-block">
                            <h1
                                class="text-5xl sm:text-7xl font-black text-slate-900 dark:text-white mb-4 font-serif tracking-tighter">
                                Friends<span class="text-brand-600">.</span>
                            </h1>
                    ...
                    <div class="space-y-3">
                        <h2 class="text-sm font-black uppercase tracking-[0.28em] text-slate-400">
                            {{ page.friendsSection.title }}
                        </h2>
                        ...
                        <a
                            ...
                            <div class="flex items-center sm:items-start gap-3 sm:gap-4">
                                ...
                                <div class="flex-grow min-w-0">
                                    <h3
                                        class="text-xs sm:text-lg font-bold text-slate-800 dark:text-slate-200 group-hover:text-brand-600 transition-colors truncate font-serif">
                                        {{ friend.name }}
                                    </h3>
                                    <p
                                        class="hidden sm:line-clamp-2 text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                                        {{ friend.description }}
                                    </p>
                                </div>
                                <div
                                    class="hidden sm:block text-slate-300 group-hover:text-brand-600 transition-colors">
                    ...
                    <div class="mt-16 space-y-12">
                        <section
                            ...
                            <div
                                class="absolute top-0 right-0 w-64 h-64 bg-brand-600/20 blur-[100px] rounded-full -mr-32 -mt-32" />
                            <div
                                class="absolute bottom-0 left-0 w-64 h-64 bg-blue-600/20 blur-[100px] rounded-full -ml-32 -mb-32" />
                            ...
                            <div class="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                                ...
                                <div
                                    class="bg-white/5 backdrop-blur-xl rounded-3xl p-5 sm:p-6 border border-white/10 space-y-5">
                                    <div class="space-y-4">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="w-10 h-10 rounded-xl bg-brand-600 flex items-center justify-center shrink-0 shadow-lg shadow-brand-500/20">
                                                <Info :size="20" />
                                            </div>
                                            <h4 class="text-lg font-black font-serif tracking-tight">
                                                {{ LINKS_PAGE_COPY.ownerTitle }}
                                            </h4>
                                        </div>
                                        ...
                                        <div class="space-y-1">
                                            <div
                                                ...
                                                <div
                                                    class="text-[11px] sm:text-xs text-slate-400 font-mono flex-grow min-w-0 break-all leading-snug">
                        ...
                        <div
                            ...
                            <div class="mb-10">
                                <h3 class="text-2xl font-black text-slate-900 dark:text-white font-serif mb-2">
                                    {{ LINKS_PAGE_COPY.applyBadgeText }}
                                </h3>
                                <p class="text-slate-500 dark:text-slate-400 text-sm">
                                    {{ LINKS_PAGE_COPY.formDescription }}
                                </p>
                            </div>
                            ...
                            <form @submit.prevent="handleSubmit" class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    <label class="text-xs font-bold text-slate-400 uppercase tracking-wider ml-1">{{
                                        LINKS_PAGE_COPY.descriptionLabel
                                    }}</label>
                                    <div class="relative">
                ...
                <UCard>
                    <template #header>
                        <div class="flex items-center justify-between">
                            <h3
                                class="text-base font-bold leading-6 text-slate-900 dark:text-white flex items-center gap-2">
                    ...
                    <div class="py-4 space-y-4">
                        <p class="text-sm text-slate-500 dark:text-slate-400 leading-relaxed">
                            您即将前往
                            <strong class="text-slate-900 dark:text-slate-200">{{ selectedFriend?.name }}</strong>
                            的站点，该网站不属于本站管理，请注意保护个人信息安全。
                        </p>
                        <div
                            class="p-3 bg-slate-50 dark:bg-slate-800/50 rounded-xl text-xs text-slate-400 font-mono break-all border border-slate-100 dark:border-slate-800">
                            {{ selectedFriend?.url }}
                        </div>
                    </div>
