  ...
  <div class="space-y-8 pb-20">
        ...
        <div>
          ...
          <p class="text-sm text-slate-500 dark:text-slate-400">维护站点名称、站点链接、简介与品牌标识。</p>
                        ...
                        <div class="space-y-2">
                            ...
                            <p
                                v-if="getFieldError('site', 'description')"
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="flex h-11 w-11 items-center justify-center rounded-2xl bg-white text-slate-500 shadow-sm dark:bg-slate-900 dark:text-slate-300">
                                <ImagePlus :size="20" />
                            </div>
                            <div>
                                <h3 class="text-sm font-bold text-slate-900 dark:text-white">站点 Logo</h3>
                                <p class="text-xs text-slate-500 dark:text-slate-400">
                                    建议使用正方形 PNG、SVG 或 WebP
                                </p>
                            </div>
                        </div>

                        <div
                            class="mt-5 overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
                            <div
                                v-if="siteLogoPreviewUrl"
                                class="flex h-52 items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.12),_transparent_60%)] p-6">
                                <img
                                    :src="siteLogoPreviewUrl"
                                    :alt="form.site.logoAlt"
                                    class="max-h-full max-w-full rounded-2xl object-contain" />
                            </div>
                            <div
                                v-else
                                class="flex h-52 flex-col items-center justify-center gap-3 bg-slate-50 text-center dark:bg-slate-950">
                                <div
                                    class="flex h-14 w-14 items-center justify-center rounded-2xl bg-slate-200 text-slate-500 dark:bg-slate-800 dark:text-slate-300">
                                    <ImagePlus :size="24" />
                                </div>
                                <div class="space-y-1">
                        ...
                        <label
                            class="mt-5 inline-flex cursor-pointer items-center gap-2 rounded-xl bg-brand-600 px-4 py-2.5 text-sm font-bold text-white transition-colors hover:bg-brand-700">
                            <Upload :size="16" />
                            上传 Logo
                            <input
                                class="hidden"
            ...
            <div>
              ...
              <p class="text-xs text-slate-500 dark:text-slate-400">建议使用正方形 PNG、SVG 或 WebP</p>
                ...
                <div class="grid gap-6 xl:grid-cols-[minmax(0,1fr)_20rem]">
                    <div class="space-y-6">
                        <div class="space-y-2">
                            <label for="owner-name" class="text-sm font-bold text-slate-900 dark:text-white"
                                >站长昵称</label
                            >
                            <input
                                id="owner-name"
                        ...
                        <div class="space-y-2">
                            <label for="owner-bio" class="text-sm font-bold text-slate-900 dark:text-white"
                                >个人简介</label
                            >
                            <textarea
                                id="owner-bio"
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            <div class="space-y-2">
                                <label for="owner-location" class="text-sm font-bold text-slate-900 dark:text-white"
                                    >所在地点</label
                                >
                                <input
                                    id="owner-location"
                                ...
                                <p
                                    v-if="getFieldError('owner', 'location')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
          ...
          <p class="text-sm text-slate-500 dark:text-slate-400">维护头像、昵称、简介以及位置标识。</p>
                    ...
                    <div
                        ...
                        <div
                            class="mt-5 overflow-hidden rounded-[1.75rem] border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
                            <div
                                v-if="ownerAvatarPreviewUrl"
                                class="flex h-52 items-center justify-center bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.16),_transparent_60%)] p-6">
                                <img
                                    :src="ownerAvatarPreviewUrl"
                                    :alt="form.owner.name"
                            ...
                            <div
                                ...
                                class="flex h-52 flex-col items-center justify-center gap-3 bg-slate-50 text-center dark:bg-slate-950">
                                <div
                                    class="flex h-14 w-14 items-center justify-center rounded-full bg-slate-200 text-slate-500 dark:bg-slate-800 dark:text-slate-300">
                                    <UserRound :size="24" />
                                </div>
                                <div class="space-y-1">
    ...
    <div v-else-if="activeTab === 'socialLinks'" class="space-y-8">
      ...
      <div class="mb-6 flex items-center gap-3">
                ...
                <div class="mb-6 flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-slate-500 dark:text-slate-400">
                            维护公开接口的人机校验、限流与登录保护参数。
                        </p>
                    </div>
                </div>

                <div class="space-y-2">
                    <label for="security-turnstile-site-key" class="text-sm font-bold text-slate-900 dark:text-white"
                    ...
                    <div class="flex items-center justify-between gap-3 text-xs">
                        ...
                        <span class="text-rose-500 dark:text-rose-300">{{
                            getFieldError('security', 'turnstileSiteKey')
                        }}</span>
                    </div>
                </div>
            </section>
            ...
            <section
                ...
                <div class="space-y-6">
                    <label class="inline-flex items-center gap-3 text-sm font-bold text-slate-900 dark:text-white">
                        <input
                            v-model="form.security.login.captchaEnabled"
                            type="checkbox"
                    ...
                    <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                        <div class="space-y-2">
                            <label for="security-login-window" class="text-sm font-bold text-slate-900 dark:text-white"
                                >时间窗口</label
                            >
                            <input
                                id="security-login-window"
                                v-model.number="form.security.login.rateLimit.windowSeconds"
                                type="number"
                                min="1"
                                class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                :class="getInputClass('security', 'login.rateLimit.windowSeconds')" />
                            <p
                                v-if="getFieldError('security', 'login.rateLimit.windowSeconds')"
                                class="text-xs text-rose-500 dark:text-rose-300">
                                {{ getFieldError('security', 'login.rateLimit.windowSeconds') }}
                            </p>
                        </div>
                        <div class="space-y-2">
                            <label for="security-login-ip" class="text-sm font-bold text-slate-900 dark:text-white"
                                >每个 IP 上限</label
                            >
                            <input
                                id="security-login-ip"
                                v-model.number="form.security.login.rateLimit.maxPerIp"
                                type="number"
                                min="1"
                                class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                :class="getInputClass('security', 'login.rateLimit.maxPerIp')" />
                            <p
                                v-if="getFieldError('security', 'login.rateLimit.maxPerIp')"
                                class="text-xs text-rose-500 dark:text-rose-300">
                                {{ getFieldError('security', 'login.rateLimit.maxPerIp') }}
                            </p>
                        </div>
                        <div class="space-y-2">
                            <label for="security-login-session" class="text-sm font-bold text-slate-900 dark:text-white"
                                >每个会话上限</label
                            >
                            <input
                                id="security-login-session"
                                v-model.number="form.security.login.rateLimit.maxPerSession"
                                type="number"
                                min="1"
                                class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                :class="getInputClass('security', 'login.rateLimit.maxPerSession')" />
                            <p
                                v-if="getFieldError('security', 'login.rateLimit.maxPerSession')"
                                class="text-xs text-rose-500 dark:text-rose-300">
                                {{ getFieldError('security', 'login.rateLimit.maxPerSession') }}
                            </p>
                        </div>
                        <div class="space-y-2">
                            <label
                                for="security-login-failures"
                                class="text-sm font-bold text-slate-900 dark:text-white"
                                >失败次数上限</label
                            >
                            <input
                                id="security-login-failures"
                                v-model.number="form.security.login.maxFailures"
                                type="number"
                                min="1"
                                class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                :class="getInputClass('security', 'login.maxFailures')" />
                            <p
                                v-if="getFieldError('security', 'login.maxFailures')"
                                class="text-xs text-rose-500 dark:text-rose-300">
                                {{ getFieldError('security', 'login.maxFailures') }}
                            </p>
                        </div>
                        <div class="space-y-2">
                            <label
                                for="security-login-cooldown"
                                class="text-sm font-bold text-slate-900 dark:text-white"
                                >冷却时间</label
                            >
                            <input
                                id="security-login-cooldown"
                                v-model.number="form.security.login.cooldownSeconds"
                                type="number"
                                min="1"
                                class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                :class="getInputClass('security', 'login.cooldownSeconds')" />
                            <p
                                v-if="getFieldError('security', 'login.cooldownSeconds')"
                                class="text-xs text-rose-500 dark:text-rose-300">
                                {{ getFieldError('security', 'login.cooldownSeconds') }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section class="grid gap-6 xl:grid-cols-2">
                <article
                    ...
                    <div class="space-y-6">
                        <label class="inline-flex items-center gap-3 text-sm font-bold text-slate-900 dark:text-white">
                            <input
                                v-model="form.security.comments.captchaEnabled"
                                type="checkbox"
                                class="h-4 w-4 rounded border-slate-300 text-brand-600 focus:ring-brand-500 dark:border-slate-700" />
                            启用评论人机校验
                        </label>
                        ...
                        <div class="grid gap-6 md:grid-cols-3">
                            <div class="space-y-2">
                                <label
                                    for="security-comments-window"
                                    class="text-sm font-bold text-slate-900 dark:text-white"
                                    >时间窗口</label
                                >
                                <input
                                    id="security-comments-window"
                                    v-model.number="form.security.comments.rateLimit.windowSeconds"
                                    type="number"
                                    min="1"
                                    class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                    :class="getInputClass('security', 'comments.rateLimit.windowSeconds')" />
                                <p
                                    v-if="getFieldError('security', 'comments.rateLimit.windowSeconds')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
                                    {{ getFieldError('security', 'comments.rateLimit.windowSeconds') }}
                                </p>
                            </div>
                            <div class="space-y-2">
                                <label
                                    for="security-comments-ip"
                                    class="text-sm font-bold text-slate-900 dark:text-white"
                                    >每个 IP 上限</label
                                >
                                <input
                                    id="security-comments-ip"
                                    v-model.number="form.security.comments.rateLimit.maxPerIp"
                                    type="number"
                                    min="1"
                                    class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                    :class="getInputClass('security', 'comments.rateLimit.maxPerIp')" />
                                <p
                                    v-if="getFieldError('security', 'comments.rateLimit.maxPerIp')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
                                    {{ getFieldError('security', 'comments.rateLimit.maxPerIp') }}
                                </p>
                            </div>
                            <div class="space-y-2">
                                <label
                                    for="security-comments-session"
                                    class="text-sm font-bold text-slate-900 dark:text-white"
                                    >每个会话上限</label
                                >
                                <input
                                    id="security-comments-session"
                                    v-model.number="form.security.comments.rateLimit.maxPerSession"
                                    type="number"
                                    min="1"
                                    class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                    :class="getInputClass('security', 'comments.rateLimit.maxPerSession')" />
                                <p
                                    v-if="getFieldError('security', 'comments.rateLimit.maxPerSession')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
                                    {{ getFieldError('security', 'comments.rateLimit.maxPerSession') }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <article
                    ...
                    <div class="mb-6 flex items-center gap-3">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-50 text-emerald-600 dark:bg-emerald-950/30 dark:text-emerald-300">
                            <ShieldCheck :size="22" />
                        </div>
                        <div>
                    ...
                    <div class="space-y-6">
                        <label class="inline-flex items-center gap-3 text-sm font-bold text-slate-900 dark:text-white">
                            <input
                                v-model="form.security.guestbook.captchaEnabled"
                                type="checkbox"
                                class="h-4 w-4 rounded border-slate-300 text-brand-600 focus:ring-brand-500 dark:border-slate-700" />
                            启用留言人机校验
                        </label>
                        ...
                        <div class="grid gap-6 md:grid-cols-3">
                            <div class="space-y-2">
                                <label
                                    for="security-guestbook-window"
                                    class="text-sm font-bold text-slate-900 dark:text-white"
                                    >时间窗口</label
                                >
                                <input
                                    id="security-guestbook-window"
                                    v-model.number="form.security.guestbook.rateLimit.windowSeconds"
                                    type="number"
                                    min="1"
                                    class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                    :class="getInputClass('security', 'guestbook.rateLimit.windowSeconds')" />
                                <p
                                    v-if="getFieldError('security', 'guestbook.rateLimit.windowSeconds')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
                                    {{ getFieldError('security', 'guestbook.rateLimit.windowSeconds') }}
                                </p>
                            </div>
                            <div class="space-y-2">
                                <label
                                    for="security-guestbook-ip"
                                    class="text-sm font-bold text-slate-900 dark:text-white"
                                    >每个 IP 上限</label
                                >
                                <input
                                    id="security-guestbook-ip"
                                    v-model.number="form.security.guestbook.rateLimit.maxPerIp"
                                    type="number"
                                    min="1"
                                    class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                    :class="getInputClass('security', 'guestbook.rateLimit.maxPerIp')" />
                                <p
                                    v-if="getFieldError('security', 'guestbook.rateLimit.maxPerIp')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
                                    {{ getFieldError('security', 'guestbook.rateLimit.maxPerIp') }}
                                </p>
                            </div>
                            <div class="space-y-2">
                                <label
                                    for="security-guestbook-session"
                                    class="text-sm font-bold text-slate-900 dark:text-white"
                                    >每个会话上限</label
                                >
                                <input
                                    id="security-guestbook-session"
                                    v-model.number="form.security.guestbook.rateLimit.maxPerSession"
                                    type="number"
                                    min="1"
                                    class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                    :class="getInputClass('security', 'guestbook.rateLimit.maxPerSession')" />
                                <p
                                    v-if="getFieldError('security', 'guestbook.rateLimit.maxPerSession')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
                                    {{ getFieldError('security', 'guestbook.rateLimit.maxPerSession') }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <article
                    ...
                    <div class="space-y-6">
                        <label class="inline-flex items-center gap-3 text-sm font-bold text-slate-900 dark:text-white">
                            <input
                                v-model="form.security.linkApplications.captchaEnabled"
                                type="checkbox"
                                class="h-4 w-4 rounded border-slate-300 text-brand-600 focus:ring-brand-500 dark:border-slate-700" />
                            启用友链申请人机校验
                        </label>
                        ...
                        <div class="grid gap-6 md:grid-cols-3">
                            <div class="space-y-2">
                                <label
                                    for="security-links-window"
                                    class="text-sm font-bold text-slate-900 dark:text-white"
                                    >时间窗口</label
                                >
                                <input
                                    id="security-links-window"
                                    v-model.number="form.security.linkApplications.rateLimit.windowSeconds"
                                    type="number"
                                    min="1"
                                    class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                    :class="getInputClass('security', 'linkApplications.rateLimit.windowSeconds')" />
                                <p
                                    v-if="getFieldError('security', 'linkApplications.rateLimit.windowSeconds')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
                                    {{ getFieldError('security', 'linkApplications.rateLimit.windowSeconds') }}
                                </p>
                            </div>
                            <div class="space-y-2">
                                <label for="security-links-ip" class="text-sm font-bold text-slate-900 dark:text-white"
                                    >每个 IP 上限</label
                                >
                                <input
                                    id="security-links-ip"
                                    v-model.number="form.security.linkApplications.rateLimit.maxPerIp"
                                    type="number"
                                    min="1"
                                    class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                    :class="getInputClass('security', 'linkApplications.rateLimit.maxPerIp')" />
                                <p
                                    v-if="getFieldError('security', 'linkApplications.rateLimit.maxPerIp')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
                                    {{ getFieldError('security', 'linkApplications.rateLimit.maxPerIp') }}
                                </p>
                            </div>
                            <div class="space-y-2">
                                <label
                                    for="security-links-session"
                                    class="text-sm font-bold text-slate-900 dark:text-white"
                                    >每个会话上限</label
                                >
                                <input
                                    id="security-links-session"
                                    v-model.number="form.security.linkApplications.rateLimit.maxPerSession"
                                    type="number"
                                    min="1"
                                    class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                    :class="getInputClass('security', 'linkApplications.rateLimit.maxPerSession')" />
                                <p
                                    v-if="getFieldError('security', 'linkApplications.rateLimit.maxPerSession')"
                                    class="text-xs text-rose-500 dark:text-rose-300">
                                    {{ getFieldError('security', 'linkApplications.rateLimit.maxPerSession') }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <article
                    ...
                    <div class="grid gap-6 md:grid-cols-3">
                        <div class="space-y-2">
                            <label for="security-likes-window" class="text-sm font-bold text-slate-900 dark:text-white"
                                >时间窗口</label
                            >
                            <input
                                id="security-likes-window"
                                v-model.number="form.security.likes.rateLimit.windowSeconds"
                                type="number"
                                min="1"
                                class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                :class="getInputClass('security', 'likes.rateLimit.windowSeconds')" />
                            <p
                                v-if="getFieldError('security', 'likes.rateLimit.windowSeconds')"
                                class="text-xs text-rose-500 dark:text-rose-300">
                                {{ getFieldError('security', 'likes.rateLimit.windowSeconds') }}
                            </p>
                        </div>
                        <div class="space-y-2">
                            <label for="security-likes-ip" class="text-sm font-bold text-slate-900 dark:text-white"
                                >每个 IP 上限</label
                            >
                            <input
                                id="security-likes-ip"
                                v-model.number="form.security.likes.rateLimit.maxPerIp"
                                type="number"
                                min="1"
                                class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                :class="getInputClass('security', 'likes.rateLimit.maxPerIp')" />
                            <p
                                v-if="getFieldError('security', 'likes.rateLimit.maxPerIp')"
                                class="text-xs text-rose-500 dark:text-rose-300">
                                {{ getFieldError('security', 'likes.rateLimit.maxPerIp') }}
                            </p>
                        </div>
                        <div class="space-y-2">
                            <label for="security-likes-session" class="text-sm font-bold text-slate-900 dark:text-white"
                                >每个会话上限</label
                            >
                            <input
                                id="security-likes-session"
                                v-model.number="form.security.likes.rateLimit.maxPerSession"
                                type="number"
                                min="1"
                                class="h-11 w-full rounded-xl border bg-slate-50 px-4 text-sm text-slate-900 outline-none transition-all focus:border-brand-600 focus:ring-4 focus:ring-brand-500/5 dark:bg-slate-950 dark:text-slate-100"
                                :class="getInputClass('security', 'likes.rateLimit.maxPerSession')" />
                            <p
                                v-if="getFieldError('security', 'likes.rateLimit.maxPerSession')"
                                class="text-xs text-rose-500 dark:text-rose-300">
                                {{ getFieldError('security', 'likes.rateLimit.maxPerSession') }}
                            </p>
                        </div>
                    </div>
                </article>
        ...
        <div v-else-if="activeTab === 'footer'" class="space-y-8">
            <section
                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    <div class="space-y-2">
                        <label for="footer-contact-email" class="text-sm font-bold text-slate-900 dark:text-white"
                            >联系邮箱</label
                        >
                        <input
                        ...
                        <p
                            v-if="getFieldError('footer', 'contactEmail')"
                            class="text-xs text-rose-500 dark:text-rose-300">
                    ...
                    <div class="space-y-2">
                        <label for="footer-copyright" class="text-sm font-bold text-slate-900 dark:text-white"
                            >版权文案</label
                        >
                        <input
                            id="footer-copyright"
                    ...
                    <div class="space-y-2">
                        <label for="footer-icp-text" class="text-sm font-bold text-slate-900 dark:text-white"
                            >备案号文本</label
                        >
                        <input
                            id="footer-icp-text"
                    ...
                    <div class="space-y-2">
                        <label for="footer-icp-link" class="text-sm font-bold text-slate-900 dark:text-white"
                            >备案链接</label
                        >
                        <input
                            id="footer-icp-link"
                ...
                <div class="mt-6 space-y-2">
                    ...
                    <div class="flex items-center justify-between gap-3 text-xs">
                        ...
                        <span
                            :class="
                                getFieldError('footer', 'note') ? 'text-rose-500 dark:text-rose-300' : 'text-slate-400'
                            ">
        ...
        <section
            class="flex flex-col gap-4 rounded-[2rem] border border-slate-100 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:flex-row sm:items-center sm:justify-between">
            <div class="space-y-1">
