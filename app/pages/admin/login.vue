<template>
    <div
        class="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div
                class="bg-white dark:bg-slate-900 py-10 px-6 shadow-2xl shadow-slate-200/50 dark:shadow-none sm:rounded-[2.5rem] sm:px-12 border border-slate-100 dark:border-slate-800 relative overflow-hidden paper-texture">
                <form @submit.prevent="handleLogin" class="space-y-6 relative z-10">
                    <div>
                        ...
                        <div class="relative group">
                            <div
                                class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-brand-600 transition-colors">
                                <User :size="18" />
                            </div>
                            <input
                                id="username"
            ...
            <div class="mt-8 text-center">
                <NuxtLink
                    to="/"
                    class="text-sm font-medium text-slate-500 hover:text-brand-600 dark:text-slate-400 transition-colors flex items-center justify-center gap-1">
                    <ArrowLeft :size="14" />
                    返回博客首页
                </NuxtLink>
            </div>
...
await Promise.all([fetchSiteSettings(), fetchSecurityPublicConfig()]);
